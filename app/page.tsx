			...
			<section className="relative h-full w-full flex flex-col justify-center items-center gap-12 text-center">
				...
				<div className="flex gap-3 justify-start z-20">
					<div className="group relative">
						<button
							onClick={handleClick}
							className="group relative inline-block h-[45px] w-[140px] md:h-[60px] md:w-[250px] overflow-hidden rounded-full text-lg text-black cursor-not-allowed"
							disabled
						>
						...
						<span className="hidden group-hover:block p-4 bg-rose-200 absolute top-[70px] rounded-md">
							Currently disabled due to Spotify API quota restrictions
						</span>
					</div>
