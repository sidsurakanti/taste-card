...
export function LastFmStatsCard({ tracks }: { tracks: LastFmTrack[] }) {
  ...
  return (
    <div className="flex justify-around items-center py-8 gap-8 bg-sky-500/25 text-sky-950 border border-sky-800/20 rounded-xl shadow-md hover:scale-95 transition-transform duration-150 text-center ">
      <span>
