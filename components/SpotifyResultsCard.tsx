...
export async function SpotifyResultsCard({
	...
	return (
		<>
			<SpotifySelectPeriod />
			<section className="mx-auto max-w-3xl flex-1 flex flex-col p-8 bg-gradient-to-b from-primary/95 via-primary/85 to-primary/75 rounded-2xl shadow-2xl">
				<div className="flex flex-row justify-between items-center gap-4 mb-5">
					<span className="w-fit flex items-center rounded-full p-1 bg-rose-500/25 border border-rose-800/20 shadow-md">
						...
						<p className="pr-5 pl-3 font-medium text-lg text-rose-950">
							{name}
						</p>
					</span>
					<span>
